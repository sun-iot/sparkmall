package com.sun.bigdata.sparkmall.mock.data

import java.util.Properties

import com.sun.bigdata.sparkmall.common.model.CityInfo
import com.sun.bigdata.sparkmall.common.util.ConfigUtils
import com.sun.bigdata.sparkmall.mock.date.{RanOpt, RandomOptions}
...
/**
  * title: MockRealTimeGenerator 
  * projectName sparkmall 
  * description: 模拟产生实时数据
  * author Sun-Smile 
  * create 2019-06-21 14:31 
  */
object MockRealTimeGenerator {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val broker = ConfigUtils.getValueConfig("kafka.broker.list")
    val topic = "ads_log"
    // 创建Kafka消费者
